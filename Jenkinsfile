pipeline {
    ...
    environment {
        ...
        IMAGE_TAG = 'latest'
        AWS_CREDENTIALS_ID = 'AKIA5VQEQTEVXYCPDH2M'  // Ensure this matches your configured credentials in Jenkins
    ...
    stages {
        ...
        stage('Deploy with Terraform') {
            steps {
                withAWS(credentials: 'AKIA5VQEQTEVXYCPDH2M', region: 'ap-south-1') {
                    sh 'terraform init'
